...
public class DataComponents {
    ...
    public static Codec<List<PlayerEntry>> LIST_CODEC;
    ...
    public static void init() {
        ...
        BOUND_PLAYERS = Registry.register(
                ...
                new ResourceLocation(PlayerXp.MOD_ID, "bound_players"),
...
//    public record BoundPlayersComponent(List<UUID> players) {
//
//        public static final BoundPlayersComponent EMPTY =
//                new BoundPlayersComponent(List.of());
//
//        public static final Codec<BoundPlayersComponent> CODEC =
//                UUIDUtil.CODEC.listOf().xmap(BoundPlayersComponent::new, BoundPlayersComponent::players);
//
//        public static final StreamCodec<FriendlyByteBuf, BoundPlayersComponent> STREAM_CODEC =
//                StreamCodec.of(
//                        (buf, comp) -> buf.writeCollection(comp.players(), (b, uuid) -> b.writeUUID(uuid)),
//                        buf -> new BoundPlayersComponent(buf.readList(b -> b.readUUID()))
//                );
//        public static BoundPlayersComponent getOrDefault(ItemStack stack) {
//            BoundPlayersComponent comp = stack.get(BOUND_PLAYERS);
//            return comp != null ? comp : BoundPlayersComponent.EMPTY;
//        }
//    }
